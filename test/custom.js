...
const customNamingFormat = [
  ...
  },
  {
    ...
    viewportWidth: 1000,
    viewportHeight: 800,
    clickElement: 'body > div.content.kp-body-component > div > div > div:nth-child(1) > div:nth-child(1) > button',
  },
  {
    testId: 'modal-merge-w-bar',
    patternName: 'Modal Merge With Bar',
    baseUrl: '',
    url: 'http://cskpcloudxn1713.cloud.kp.org/patterns-library/lauren-dev/modal-demo/',
    appName: "Modal Pattern",
    viewportWidth: 1000,
